...
async function initializeApp() {
    ...
    try {
        ...
        // NAS Manager
        window.nasManager = new NASManager();
        ...
        // ==========================================
        // STEP 4.5: Initialize NAS Manager
        // ==========================================
        console.log('\n📡 Step 4.5: Initializing NAS manager...');
        window.nasManager.init();
        console.log('✅ NAS manager initialized');
